...
with form2:
        ...
        judul = form2.selectbox('Pilih Judul Buku',('','The Great Gatsby by F. Scott Fitzgerald','To Kill a Mockingbird by Harper Lee','1984 by George Orwell','Pride and Prejudice by Jane Austen','The Catcher in the Rye by J.D. Salinger','Little Women by Lousia May Alcott','Poor Dad Rich Dad by Robert T. Kiyosaki','Atomic Habits by James Clear','Moby Dick by Herman Melvile','Sapiens by Yuval Noah Harari','Aplikasi Komputer','Dasar-Dasar Teknik Informatika','Komputer Cerdas','Metode Penelitian Teknik Informatika','Pengantar Teknologi Informasi','Pengantar Teknologi Informatika dan Komunikasi Data','Teknik Pengolahan Audio & Video'))
